...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:ClusterNetwork/Attribute:networkdevices_list' => 'Nós',
	...
	'Class:ClusterNetwork/Attribute:redundancy' => 'Alta disponibilidade',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
    ...
    'Class:PhysicalInterface/Attribute:networkmodule_id' => 'Módulo de rede',
    'Class:PhysicalInterface/Attribute:networkmodule_id+' => 'Transceptor a ser conectado na interface',
    'Class:PhysicalInterface/Attribute:networkmodule_name' => 'Nome do módulo de rede',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
    ...
    'Class:VLAN/Attribute:aggregatelinks_list' => 'Links agregados',
    'Class:VLAN/Attribute:aggregatelinks_list+' => 'Lista de todos os links agregados anexados a esta VLAN',
));
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:SnmpCredentials/Attribute:community' => 'Comunidade',
	'Class:SnmpCredentials/Attribute:community+' => 'String de comunidade conhecida para V1 e V2',
	...
	'Class:SnmpCredentials/Attribute:security_level+' => 'Seleção do modelo de segurança baseado em usuário (USM). Quando deixado vazio, as credenciais usam a string de comunidade SNMP V1 / V2c.',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:NetworkFlow/Attribute:org_id+' => 'Organização à qual o fluxo pertence',
	...
	'Class:NetworkFlow/Attribute:interfacespeed_id' => 'Largura de banda',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
    'Class:NetworkModule' => 'Módulo de Rede',
    'Class:NetworkModule+' => 'Transceptor conectável que pode ser inserido em uma interface física',
    'Class:NetworkModule:baseinfo' => 'Informações Gerais',
    'Class:NetworkModule:moreinfo' => 'Mais Informações',
    'Class:NetworkModule:Date' => 'Datas',
    'Class:NetworkModule:otherinfo' => 'Detalhes Técnicos',
    'Class:NetworkModule/Attribute:description' => 'Descrição',
    'Class:NetworkModule/Attribute:description+' => '',
    'Class:NetworkModule/Attribute:connectableci_id' => 'Dispositivo',
    'Class:NetworkModule/Attribute:connectableci_id+' => 'Dispositivo que hospeda a interface na qual o módulo está conectado',
    'Class:NetworkModule/Attribute:connectableci_name' => 'Nome do dispositivo',
    'Class:NetworkModule/Attribute:connectableci_name+' => '',
    'Class:NetworkModule/Attribute:physicalinterface_id' => 'Interface física',
    'Class:NetworkModule/Attribute:physicalinterface_id+' => 'Interface na qual o módulo está conectado',
    'Class:NetworkModule/Attribute:physicalinterface_name' => 'Nome da interface física',
    'Class:NetworkModule/Attribute:physicalinterface_name+' => '',
    'Class:NetworkModule/Attribute:physicalinterface_speed' => 'Velocidade da interface física',
    'Class:NetworkModule/Attribute:physicalinterface_speed+' => 'Velocidade na qual a interface física pode operar',
    'Class:NetworkModule/Attribute:networkmoduletype_id' => 'Tipo de módulo',
    'Class:NetworkModule/Attribute:networkmoduletype_id+' => '',
    'Class:NetworkModule/Attribute:networkmoduletype_name' => 'Nome do módulo',
    'Class:NetworkModule/Attribute:networkmoduletype_name+' => '',
    'Class:NetworkModule/Attribute:max_data_rate' => 'Máxima Taxa de Dados.',
    'Class:NetworkModule/Attribute:max_data_rate+' => 'Velocidade na qual o módulo pode operar',
));
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
    'Class:NetworkModuleType' => 'Tipo de Módulo de Rede',
    'Class:NetworkModuleType+' => '',
    'Class:NetworkModuleType:baseinfo' => 'Informações Gerais',
    'Class:NetworkModuleType:opticalinfo' => 'Detalhes Ópticos',
    'Class:NetworkModuleType/Attribute:form_factor' => 'Fator de forma',
    'Class:NetworkModuleType/Attribute:form_factor+' => '',
    'Class:NetworkModuleType/Attribute:form_factor/Value:integrated' => 'Integrado',
    ...
    'Class:NetworkModuleType/Attribute:form_factor/Value:sfp+' => 'Transceptor de formato compacto conectável (SFP)',
    'Class:NetworkModuleType/Attribute:form_factor/Value:sfp_plus' => 'SFP+',
    'Class:NetworkModuleType/Attribute:form_factor/Value:sfp_plus+' => 'Transceptor de formato compacto conectável aprimorado (SFP+)',
    'Class:NetworkModuleType/Attribute:form_factor/Value:osfp' => 'OSFP',
    'Class:NetworkModuleType/Attribute:form_factor/Value:osfp+' => 'Transceptor de formato compacto conectável octal (OSFP)',
    'Class:NetworkModuleType/Attribute:form_factor/Value:qsfp' => 'QSFP',
    'Class:NetworkModuleType/Attribute:form_factor/Value:qsfp+' => 'Transceptor de formato compacto conectável quádruplo (QSFP)',
    'Class:NetworkModuleType/Attribute:form_factor/Value:qsfp_plus' => 'QSFP+',
    'Class:NetworkModuleType/Attribute:form_factor/Value:qsfp_plus+' => 'Transceptor de formato compacto conectável quádruplo aprimorado (QSFP+)',
    'Class:NetworkModuleType/Attribute:form_factor/Value:xfp' => 'XFP',
    'Class:NetworkModuleType/Attribute:form_factor/Value:xfp+' => 'Transceptor SFP+ de 10 gigabits',
    'Class:NetworkModuleType/Attribute:form_factor/Value:gbic' => 'GBIC',
    'Class:NetworkModuleType/Attribute:form_factor/Value:gbic+' => 'Conversor de interface gigabit (GBIC)',
    'Class:NetworkModuleType/Attribute:form_factor/Value:minigbic' => 'Mini GBIC',
    'Class:NetworkModuleType/Attribute:form_factor/Value:minigbic+' => 'Mini conversor de interface gigabit (Mini-GBIC) ou SFP',
    'Class:NetworkModuleType/Attribute:form_factor/Value:other' => 'Outro',
    'Class:NetworkModuleType/Attribute:form_factor/Value:other+' => '',
    'Class:NetworkModuleType/Attribute:description' => 'Descrição',
    'Class:NetworkModuleType/Attribute:description+' => '',
    'Class:NetworkModuleType/Attribute:interfacespeed_id' => 'Velocidade',
    'Class:NetworkModuleType/Attribute:interfacespeed_id+' => '',
    'Class:NetworkModuleType/Attribute:interfacespeed_name' => 'Nome da velocidade',
    'Class:NetworkModuleType/Attribute:interfacespeed_name+' => '',
    'Class:NetworkModuleType/Attribute:interfaceconnector_id' => 'Conector',
    'Class:NetworkModuleType/Attribute:interfaceconnector_id+' => '',
    'Class:NetworkModuleType/Attribute:interfaceconnector_name' => 'Nome do conector',
    'Class:NetworkModuleType/Attribute:interfaceconnector_name+' => '',
    'Class:NetworkModuleType/Attribute:optical_reach' => 'Alcance óptico',
    'Class:NetworkModuleType/Attribute:optical_reach+' => '',
    'Class:NetworkModuleType/Attribute:optical_reach/Value:sr' => 'SR',
    'Class:NetworkModuleType/Attribute:optical_reach/Value:sr+' => 'Curto Alcance (Short Reach)',
    'Class:NetworkModuleType/Attribute:optical_reach/Value:lr' => 'LR',
    'Class:NetworkModuleType/Attribute:optical_reach/Value:lr+' => 'Longo Alcance (Long Reach)',
    'Class:NetworkModuleType/Attribute:optical_reach/Value:lrm' => 'LRM',
    'Class:NetworkModuleType/Attribute:optical_reach/Value:lrm+' => 'Modo de Longo Alcance (Long Reach Mode)',
    'Class:NetworkModuleType/Attribute:optical_reach/Value:er' => 'ER',
    'Class:NetworkModuleType/Attribute:optical_reach/Value:er+' => 'Alcance Estendido (Extended Reach)',
    ...
    'Class:NetworkModuleType/Attribute:optical_reach/Value:zr+' => 'Alcance Estendido (Extended Reach - Unofficial format)',
    ...
    'Class:NetworkModuleType/Attribute:optical_reach/Value:other' => 'Outro',
    'Class:NetworkModuleType/Attribute:optical_reach/Value:other+' => '',
    'Class:NetworkModuleType/Attribute:wltx' => 'TX lambda',
    'Class:NetworkModuleType/Attribute:wltx+' => 'Comprimento de onda TX ou comprimento de onda de transmissão para módulos bidirecionais',
    'Class:NetworkModuleType/Attribute:wlrx' => 'RX lambda',
    'Class:NetworkModuleType/Attribute:wlrx+' => 'Comprimento de onda RX para módulos bidirecionais',
    'Class:NetworkModuleType/Attribute:networkmodules_list' => 'Módulos de rede',
    'Class:NetworkModuleType/Attribute:networkmodules_list+' => 'Lista de todos os módulos de rede deste tipo',
    'NetworkModuleType:Overview:NetworkModules' => 'Lista de todos os módulos de rede deste tipo',
));
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
    ...
    'UI:NetworkMgmtExtended:Action:CreateOrUpdate:PhysicalInterface:PointToConnectorAndModule' => 'Uma interface física não pode ser vinculada A AMBOS um conector de interface e um módulo de rede!',
));
